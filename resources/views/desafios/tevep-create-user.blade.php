    ...
    <div class="container-fluid p-0 sm_padding_15px">
        <div class="row mb-2">
            <div class="col-6 d-flex align-items-center">
                <a href="{{ route('tevep.user', $usuario->id) }}" class="btn btn-sm btn-outline-secondary">
        ...
        <form method="POST" action="{{ route('tevep.update', ['user' => $usuario->id, 'desafioUser' => $desafioUser->id]) }}">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="area_estrategica" class="form-control" placeholder="Ex: XP Marketing" value="{{ old('area_estrategica') }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Indicador</label>
                            <input type="text" name="indicador" class="form-control" placeholder="Objetivo principal" value="{{ old('indicador') }}">
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="nome_evento" class="form-control" value="{{ old('nome_evento') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Espaço</label>
                            <input type="text" name="espaco" class="form-control" placeholder="Local de realização" value="{{ old('espaco') }}">
                        </div>
                    </div>
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="form-label">Pessoas Envolvidas</label>
                            <input type="text" name="pessoas_envolvidas" class="form-control" placeholder="Membros, Senadores, Aspirantes..." value="{{ old('pessoas_envolvidas') }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea name="utilidade_objetivo" rows="3" class="form-control" placeholder="Descreva o objetivo e o propósito do projeto">{{ old('utilidade_objetivo') }}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Inerências (Planejamento)</label>
                            <textarea name="inerencias_planejamento" rows="3" class="form-control" placeholder="Planejamento das ações, organização das atividades...">{{ old('inerencias_planejamento') }}</textarea>
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <label class="form-label">Expectativas</label>
                            <textarea name="expectativas" rows="3" class="form-control" placeholder="Resultados esperados, participação, impacto...">{{ old('expectativas') }}</textarea>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Custo</label>
                            <input type="text" name="custo" class="form-control mask-currency" placeholder="Orçamento estimado" value="{{ old('custo') }}">
                            @error('custo')
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="entrega" class="form-control" placeholder="Tipo de entrega" value="{{ old('entrega') }}">
                            @error('entrega')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="atendimento" class="form-control" placeholder="Ex: Telefonia, e-mail, WhatsApp" value="{{ old('atendimento') }}">
                            @error('atendimento')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="qualidade" class="form-control" placeholder="Critérios de qualidade" value="{{ old('qualidade') }}">
                            @error('qualidade')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-3">
                            ...
                            <textarea name="inovacao" rows="2" class="form-control" placeholder="Ações diferenciadas, novidades...">{{ old('inovacao') }}</textarea>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Logística</label>
                            <textarea name="logistica" rows="2" class="form-control" placeholder="Contatos, fornecedores, parcerias...">{{ old('logistica') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end mb-4">
                <button type="submit" class="btn btn-primary">Criar TEVEP</button>
            </div>
        </form>
    </div>
</div>
