...
(gj.core = {
    ...
    position: function(a) {
        for (
            var b, c, d = 0, e = 0, f = gj.core.height(a), g = gj.core.width(a); a;
    ...
    move: function(a, b, c, d, e, f) {
        ...
        b.containment &&
            ((g = gj.core.position(b.containment)),
                ...
                (l = l <= g.left ? g.left + 1 : i - 1)), !1 !== gj.draggable.events.drag($(a), l, k, e, f) &&
...
(gj.grid.methods = {
    ...
    renderDisplayElement: function(a, b, c, d, e, f) {
        ...
        "checkbox" === c.type && gj.checkbox ?
            ...
            ((d[c.field] = gj.grid.methods.formatText(d[c.field], c)), !c.tooltip && d[c.field] && b.attr("title", d[c.field]),
                b.html(d[c.field])),
    ...
    destroy: function(a, b, c) {
        return (
            ...
            (gj.grid.events.destroying(a),
                ...
                a.unwrap(),
                a.removeData(), !1 === b ? a.remove() : a.removeClass().empty(),
                a.removeAttr("data-type")),
            a
        );
    },
...
(gj.grid.plugins.responsiveDesign = {
    ...
    private: {
        ...
        updateDetails: function(a) {
            var b, c, d, e, f, g, h, i, j;
            for (
                b = a.find('tbody > tr[data-role="row"]'), c = a.data(), d = 0; d < b.length; d++
            ) {
                for (
                    f = $(b[d]), g = f.data("details"), e = 0; e < c.columns.length; e++
                )
                    (i = c.columns[e]),
    ...
    public: {
        ...
        makeResponsive: function() {
            ...
            if (c)
                for (a = 0; a < e.length; a++)
                    (b = this.find("thead>tr>th:eq(" + e[a].position + ")")), !b.is(":visible") &&
                    e[a].minWidth <= c &&
...
(gj.tree.methods = {
    ...
    loadData: function(a) {
        var b,
            ...
            d = a.children("ul");
        for (
            gj.tree.events.dataBinding(a), d.off().empty(), b = 0; b < c.length; b++
        )
    ...
    expand: function(a, b, c) {
        var d,
            ...
            h = b.attr("data-id"),
            i = b.children("ul");
        if (!1 !== gj.tree.events.expand(a, b, h) &&
            i &&
            i.length &&
            (i.show(),
    ...
    collapse: function(a, b, c) {
        var d,
            ...
            h = b.attr("data-id"),
            i = b.children("ul");
        if (!1 !== gj.tree.events.collapse(a, b, h) &&
            i &&
            i.length &&
            (i.hide(),
                    ...
                    d.each(function() {
                        ...
                        if (d.droppable("isOver", g))
                            return (
                                ...
                                (c = i.children("ul")),
                                0 === c.length &&
                                ((c = $("<ul />").addClass(f.style.list)), i.append(c)), !1 !==
                        ...
                        if (k.droppable("isOver", g))
                            return (
                                ...
                                ((h = a.getDataById(b.data("id"))),
                                    ...
                                    a
                                    .getDataById(i.parent().data("id"))[f.childrenField].splice(i.index() + (c ? 0 : 1), 0, h),
                                    c ? b.insertBefore(i) : b.insertAfter(i),
                                    gj.tree.plugins.dragAndDrop.private.refresh(a, b, i, j)), !1
                            );
                        k.droppable("destroy");
                    });
            };
...
(gj.datepicker.methods = {
    ...
    initialize: function(a, b) {
        ...
        0 === e.length ?
            ...
            (c = gj.datepicker.methods.createCalendar(a, b)), !0 !== b.footer &&
            (a.on("blur", function() {
                    a.timeout = setTimeout(function() {
                        gj.datepicker.methods.close(a);
                    }, 500);
                ...
                c.mousedown(function() {
                    return (
                        ...
                        document.activeElement !== a[0] && a.focus(), !1
                    );
                }),
                c.on("click", function() {
                    clearTimeout(a.timeout),
    ...
    createCalendar: function(a, b) {
        ...
        return (
            ...
            (c = gj.core.parseDate(b.value, b.format, b.locale)), !c || isNaN(c.getTime()) ?
            (c = new Date()) :
            a.attr(
                "day",
    ...
    dayClickHandler: function(a, b, c, d) {
        return function(e) {
            return (
                e && e.stopPropagation(),
                gj.datepicker.methods.selectDay(a, b, c, d), !0 !== c.footer &&
                !1 !== c.autoClose &&
...
(gj.timepicker.methods = {
    ...
    createPicker: function(a) {
        ...
        return (
            (b = gj.core.parseDate(c.value, c.format, c.locale)), !b || isNaN(b.getTime()) ?
            (b = new Date()) :
